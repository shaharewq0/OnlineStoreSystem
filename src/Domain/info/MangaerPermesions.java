...
public class MangaerPermesions {
	...
	public static final String[] permesions = { "addItem", "editItem", "removeItem", "getPurchaseHistory", "viewQuestions",
			"giveRespond", "appointOwner", "appointManager", "fire", "getfire", "editManagerPermesions" ,"addDiscount", "getDiscountsString", "removeDiscount","addacquisition","removeacquisition", "getacquisition"};
