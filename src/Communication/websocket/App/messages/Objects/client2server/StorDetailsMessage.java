...
public class StorDetailsMessage extends Client2ServerMessage {

    private String name;

    public StorDetailsMessage(long id, String name) {
    ...
    public boolean equals(Object o) {
        ...
        StorDetailsMessage that = (StorDetailsMessage) o;
